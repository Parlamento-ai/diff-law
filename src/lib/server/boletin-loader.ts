...
const BOLETIN_DIRS: Record<string, string> = {
	...
	// Pipeline outputs — generated by `npx tsx pipeline/cl/process.ts <boletin>`
	// Uncomment to view pipeline-generated boletines:
	// 'pipeline-17370': 'output/17370/akn',
	// 'pipeline-15995': 'output/15995/akn',
	// 'pipeline-8924': 'output/8924/akn',
