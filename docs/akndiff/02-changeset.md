...
The `changeSet` is the core of AKN Diff. It lives as a direct child of the document element (`bill`, `amendment`, or `act`) and describes the computable difference between two versions of a document.

## Structure

```xml
<akndiff:changeSet base="..." result="...">
  <akndiff:vote .../>             <!-- optional: voting record -->
  <akndiff:articleChange .../>    <!-- one per modified article -->
...
<akndiff:articleChange article="art_5" type="substitute">
  <akndiff:old>Previous text of the article.</akndiff:old>
  <akndiff:new>New text of the article.</akndiff:new>
</akndiff:articleChange>
```
...
<akndiff:articleChange article="art_1" type="substitute">
  <akndiff:old>Se utilizarán 400 gramos de arroz bomba de denominación
  de origen Valencia. Queda prohibido el uso de cualquier otra
  variedad de arroz.</akndiff:old>
  <akndiff:new>Se utilizarán 400 gramos de arroz bomba o, alternativamente,
  arroz redondo de grano medio. Se recomienda preferentemente el arroz
  bomba cuando esté disponible.</akndiff:new>
</akndiff:articleChange>
```
...
```xml
<akndiff:articleChange article="art_5bis" type="insert" after="art_5">
  <akndiff:new>Cuando se utilicen mariscos según el artículo 5, el plato
  deberá denominarse 'paella mixta' y no 'paella valenciana'.</akndiff:new>
</akndiff:articleChange>
```
...
```xml
<akndiff:articleChange article="art_12" type="repeal">
  <akndiff:old>Text of the repealed article.</akndiff:old>
</akndiff:articleChange>
```
...
Previous: [Overview](/docs/akndiff/overview) | Next: [The vote element](/docs/akndiff/voting)
