...
Lo primero que busco es explorar lo existente. Con un simple deep research ([primera búsqueda](research/2026-01-30/primera-busqueda.md)) vi que hay muchas cosas existentes y que varían bastante de país en país. Decidí hacer una búsqueda para cada país mencionado y para tener mucho más detalle sobre las propuestas e implementaciones ya vigentes (ver [research por país](research/2026-01-30/country)).
